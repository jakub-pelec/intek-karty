...
export interface ApiAchievementAchievement extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    pointReward: Schema.Attribute.Integer &
      Schema.Attribute.Required &
...
export interface ApiBoosterBooster extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    active: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<true>;
    backImage: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dropRates: Schema.Attribute.Component<'booster.drop-rate', true> &
      Schema.Attribute.Required;
    frontImage: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    holographicChancePercent: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          max: 100;
    ...
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    twitchChannelPointCost: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 1;
        ...
        number
      >;
    twitchRewardId: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiCardCard extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    holoMap: Schema.Attribute.Media<'images'>;
...
export interface ApiCollectionCollection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    active: Schema.Attribute.Boolean &
      ...
      Schema.Attribute.DefaultTo<true>;
    backImage: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    boosters: Schema.Attribute.Relation<'oneToMany', 'api::booster.booster'>;
