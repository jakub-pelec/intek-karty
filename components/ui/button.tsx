...
const buttonVariants = cva(
  "ritual-ember inline-flex items-center justify-center gap-2 rounded-none font-[family-name:var(--font-cinzel)] text-[10px] font-medium tracking-[0.24em] uppercase disabled:pointer-events-none disabled:opacity-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#d4b36a]",
  {
    variants: {
      variant: {
        primary:
